...
def formater_donnees_finales(stats_employes):
    ...
    # Colonnes optionnelles importantes (peuvent ne pas être présentes)
    colonnes_optionnelles = [
        'UM (Lib)',  # NOUVEAU: Direction Régionale pour les statistiques par DR
        'FSDUM (Lib)'  # Agence pour les statistiques par agence
    ]
    ...
    for col in colonnes_optionnelles + nouvelles_colonnes:
