...
class ExportManager:
    ...
    def export_to_excel(self, stats_final, moyennes_equipe, csv_file_path):
        ...
        try:
            ...
            sauvegarder_excel(stats_final, moyennes_equipe, file_path)
            ...
            messagebox.showinfo(
                ...
                f"📊 Contenu : {len(stats_final)} employés, {len(moyennes_equipe)} équipes"
            )
